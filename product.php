...
{   if(!file_exists("image/Salon/".$id."/productimages"))
	{
		$dir=mkdir("image/Salon/".$id."/productimages");
	}
...
{   if(isset($_SESSION['id']))
	...
	if(mysqli_query($con,"insert into tbproduct(fldvendor_id,productname,cost,cosmetics,paymentmode,fldimage) values
	
	('$v_id','$product_name','$cost','$cosmetics','$paymentmode','$img_name')"))
	{
		move_uploaded_file($_FILES['product_pic']['tmp_name'],"image/Salon/$id/productimages/".$_FILES['product_pic']['name']);
	}
	else{
		echo "failed";
	}
...
if(isset($upd_account))
			  ...
			  if(isset($upd_logo))
			  {
				  ...
				  if(mysqli_query($con,"update tblvendor set fld_logo='$new_img_name' where fld_email='$id'"))
				  {
					  ...
					  move_uploaded_file($_FILES['logo_pic']['tmp_name'],"image/Salon/$id/".$_FILES['logo_pic']['name']);
	   ...
	   <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="home-tab">
			 ...
			 <th>Update item Details </th>
			   <?php
					  if($query=mysqli_query($con,"select tblvendor.fldvendor_id,tblvendor.fld_email,tbproduct.product_id,tbproduct.productname,tbproduct.cost,tbproduct.paymentmode,tbproduct.cosmetics,tbproduct.fldimage,tblvendor.fld_name from tblvendor inner join tbproduct on tblvendor.fldvendor_id=tbproduct.fldvendor_id where tblvendor.fld_email='$id'"))
					  {
						  if(mysqli_num_rows($query))
						  {
				...
				<td><img src="<?php echo 'image/Salon/'.$id.'/productimages/'.$row['fldimage'];?>" height="100px" width="150px"></td>
				<td style="width:150px;"><?php  echo $row['productname']."<br>";?></td>
				<td align="center" style="width:150px;"><?php  echo $row['cost']."<br>";?></td>
				<td  align="center" style="width:150px;"><?php  echo $row['cosmetics']."<br>";?></td>
				<td align="center" style="width:150px;"><?php  echo $row['paymentmode']."<br>";?></td>
				
				<td align="center" style="width:150px;">
				
				<a href="vendor_delete_product.php?product_id=<?php echo $row['product_id'];?>"><button type="button" class="btn btn-warning">Delete </button></a>
				
				</td>
				<td align="center" style="width:150px;">
				
				<a href="update.php?product_id=<?php echo $row['product_id'];?>"><button type="button" class="btn btn-danger">Update </button></a>
			         ...
			         <!--add Product-->
                        <form action="" method="post" enctype="multipart/form-data">
                                     ...
                                     <label for="product_name">Product Name:</label>
                                            <input type="text" class="form-control" id="product_name" value="<?php if(isset($product_name)) { echo $product_name;}?>" placeholder="Enter Product Name" name="product_name" required>
                                     </div>
	                                 ...
	                                 <div class="form-group"><!--Cosmetics-->
                                            <label for="Cosmetics">Cosmetics :</label>
                                            <input type="text" class="form-control" id="Cosmetics" value="<?php if(isset($Cosmetics)) { echo $Cosmetics;}?>" placeholder="Enter Cosmetics" name="Cosmetics" required>
                                    </div>
	                                ...
	                                <div class="form-group">
                                         <input type="file" accept="image/*" name="product_pic" required/>Product Snaps 
                                    </div>
			 ...
			 <div class="tab-pane fade " id="status" role="tabpanel" aria-labelledby="status-tab">
				...
				if(mysqli_num_rows($orderquery))
				{
					while($orderrow=mysqli_fetch_array($orderquery))
					{
						...
						<td><?php echo $orderrow['fld_product_id']; ?></td>
						<?php
