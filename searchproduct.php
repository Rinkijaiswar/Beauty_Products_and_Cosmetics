...
<div class="row">
   ...
   <?php
	  ...
	  tblvendor.fld_phone,tblvendor.fld_address,tblvendor.fld_logo,tbproduct.productname,tbproduct.cost,
	  tbproduct.cosmetics,tbproduct.paymentmode,tbproduct.fldimage from tblvendor inner join
	  tbproduct on tblvendor.fldvendor_id=tbproduct.fldvendor_id where tbproduct.product_id='$fid'");
	  ...
	  <div class="row" style="padding:10px;padding-top:0px;padding-right:0px; padding-left:0px;">
		 <div class="col-sm-12"><img src="<?php echo $product_pic; ?>" class="rounded" height="400px" width="100%" alt="Cinque Terre"></div>
