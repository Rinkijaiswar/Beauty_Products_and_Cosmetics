  ...
  <div class="row">
    <div class="col-sm-8" style="padding:20px; border:1px solid #F0F0F0;">
	    <form method="post">
			...
			<div class="form-group">
                 <input type="tel" class="form-control" pattern="[6-9]{1}[0-9]{9}"  name="phone" placeholder="Phone(optinal) EX 91 9136301204"/>
            </div>
			<div class="form-group">
    ...
    <div class="col-sm-4" style="padding:30px;">
	   <div class="form-group">
           <i class="fa fa-phone" aria-hidden="true"></i>&nbsp;<b>91 8291680474</b><br><br>
			<i class="fa fa-home" aria-hidden="true"></i>&nbsp; M G Road, Unnat Nagar, Goregaon, Mumbai 400 102, Maharastra<br>(24*7 Days)
