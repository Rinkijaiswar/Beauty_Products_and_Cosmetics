...
<div class="container">
	...
	<!--tab 1 starts-->   
	   <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="viewitem-tab">
                 ...
                 <thead>
                    <tr>
                        <th scope="col">Salon_Id</th>
                            <th scope="col">Product View</th>
                            <th scope="col">Beauty Cosmetics</th>
				 ...
				 <tbody>
	<?php
	$query=mysqli_query($con,"select tblvendor.fldvendor_id,tblvendor.fld_name,tblvendor.fld_email,tbproduct.product_id,tbproduct.productname,tbproduct.cosmetics,tbproduct.fldimage from  tblvendor right join tbproduct on tblvendor.fldvendor_id=tbproduct.fldvendor_id");
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/Salon/<?php echo $row['fld_email']."/productimages/" .$row['fldimage'];?>" height="50px" width="100px">
						<br><?php echo $row['productname'];?>
						</td>
						<td><?php echo $row['cosmetics'];?></td>
						...
						<form method="post">
                        <td><a href=""><button type="submit" value="<?php echo $row['product_id']; ?>" name="delete"  class="btn btn-danger">Remove </button></td>
                        </form>
                   </tr>
		<?php
		}
...
<!--tab 1 ends-->	   
			 ...
			 <div class="tab-pane fade show" id="ManageVendors" role="tabpanel" aria-labelledby="ManageVendors-tab">
			    <div class="container">
                 ...
                 <thead>
                    <tr>
                        <th scope="col"></th>
                            <th scope="col">Salon Id/vendor Id</th>
	...
	?>			 
                    ...
                    <tr>
						...
						<td><img src="image/Salon/<?php echo $row['fld_email']."/" .$row['fld_logo'];?>" height="50px" width="100px"></td>
                        <th scope="row"><?php echo $row['fldvendor_id'];?></th>
						<td><?php echo $row['fld_name'];?></td>
		...
		?>		   
			 ...
			 <div class="tab-pane fade" id="orderstatus" role="tabpanel" aria-labelledby="orderstatus-tab">
			   ...
			   <td><a href="searchproduct.php?product_id=<?php echo $rrr['fld_product_id']; ?>"><?php echo $rrr['fld_product_id']; ?></td>
