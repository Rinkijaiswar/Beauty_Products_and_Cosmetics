                 ...
                 <table class="table">
                  <tbody>
	               <?php
	                ...
	                ?>
                      <tr>
                         <td><image src="../image/salon/<?php echo $em."/productimages/".$res['fldimage'];?>" height="80px" width="100px"></td>
                         <td><?php echo $res['productname'];?></td>
                         <td><?php echo "RS ".$res['cost'];?></td>
                         <td><?php echo $res['cosmatics'];?></td>
                         <td><?php echo $nm; ?></td>
                   ...
                   <?php
						...
						<tr>
					  <td>
					  <h5 style="color:red;">A1 Beauty Shine</h5>
					  </td>
					  <td>
            ...
            <div class="tab-pane fade" id="orders" role="tabpanel" aria-labelledby="orders-tab">
				...
				<th>Cancel order</th>
					...
					?>
					   ...
					   {
						   ?>
						    <td><?php echo $qrr['productname']; ?></td>
						   <?php
					   }
					   ?>
