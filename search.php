...
<style>
#aboutus{
     background-image:url("img/search back.webp");
...
<!--menu ends-->
<div class="container" >
<img  src="img/Salon2.jpg" alt="no Pic Available" height="600px" width="100%">
</div>
...
<div class="row">
   ...
   <span style="color:#A5A5A5;font-size:25px;text-transform:uppercase;"><i class="fas fa-home"></i></span>&nbsp;&nbsp;<span style="font-family: 'serif'; font-weight:bold;font-size:25px; color:#ED2553;"><?php echo $row['fld_address']?></span><br><br>
