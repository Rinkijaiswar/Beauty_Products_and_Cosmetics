...
$re=mysqli_query($con,"select * from tbproduct where fldvendor_id='$Vendorid'");
...
if($re_no)
{
	unset($_SESSION['id']);
	 ...
	 $vend_row=mysqli_fetch_array($vend_info);
	  ...
	  $product_img=$re_arr['fldimage'];
	 unlink("image/Salon/$em/productimages/$product_img");
	// rmdir("image/Salon/$em/productimages");
	 unlink("image/Salon/$em/$im");
	 //rmdir("image/Salon/$em");
	 mysqli_query($con,"delete from tbproduct where fldvendor_id='$Vendorid'");
